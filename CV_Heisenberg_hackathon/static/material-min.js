	...
	for (var i = [ 'webkit', 'moz' ], n = 0; n < i.length && !window.requestAnimationFrame; ++n) {
		...
		(window.requestAnimationFrame = window[a + 'RequestAnimationFrame']),
			(window.cancelAnimationFrame =
				window[a + 'CancelAnimationFrame'] || window[a + 'CancelRequestAnimationFrame']),
	...
	(window.MaterialMenu = d),
			...
			if (this.element_ && this.container_ && this.forElement_) {
				...
				t &&
					...
					(e.keyCode === this.Keycodes_.UP_ARROW
						...
						: e.keyCode === this.Keycodes_.DOWN_ARROW && (e.preventDefault(), t[0].focus()));
			}
		}),
			...
			if (this.element_ && this.container_) {
				...
				if (t && t.length > 0 && this.container_.classList.contains(this.CssClasses_.IS_VISIBLE)) {
					...
					if (e.keyCode === this.Keycodes_.UP_ARROW)
						e.preventDefault(), s > 0 ? t[s - 1].focus() : t[t.length - 1].focus();
		...
		(d.prototype.show = function(e) {
			if (this.element_ && this.container_ && this.outline_) {
				...
				for (
					var i = this.Constant_.TRANSITION_DURATION_SECONDS * this.Constant_.TRANSITION_DURATION_FRACTION,
	...
	(window.MaterialTooltip = I),
		...
		(I.prototype.handleMouseEnter_ = function(e) {
			...
			this.element_.classList.contains(this.CssClasses_.RIGHT)
				? ((s = t.width / 2),
					i + a < 0
						? ((this.element_.style.top = '0'), (this.element_.style.marginTop = '0'))
						: ((this.element_.style.top = i + 'px'), (this.element_.style.marginTop = a + 'px')))
				: s + n < 0
						...
						(this.header_.classList.contains(this.CssClasses_.HEADER_SEAMED)
							...
							: this.header_.classList.contains(this.CssClasses_.HEADER_WATERFALL)
								...
								: this.header_.classList.contains(this.CssClasses_.HEADER_SCROLL) &&
									((o = this.Mode_.SCROLL), e.classList.add(this.CssClasses_.HAS_SCROLLING_HEADER)),
				...
				if (
					...
					var E = function() {
						this.tabBar_.scrollLeft > 0
							...
							this.tabBar_.scrollLeft < this.tabBar_.scrollWidth - this.tabBar_.offsetWidth
								? C.classList.add(this.CssClasses_.IS_ACTIVE)
								: C.classList.remove(this.CssClasses_.IS_ACTIVE);
					}.bind(this);
						...
						if (null !== this.rippleElement_) {
							...
							t
								...
								: ((i = this.Constant_.FINAL_SCALE),
									...
									e &&
										(a = 'translate(' + this.boundWidth / 2 + 'px, ' + this.boundHeight / 2 + 'px)')),
