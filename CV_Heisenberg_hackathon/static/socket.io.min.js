!(function(t) {
	if ('object' == typeof exports && 'undefined' != typeof module) module.exports = t();
		...
		'undefined' != typeof window
			? (e = window)
			: 'undefined' != typeof global ? (e = global) : 'undefined' != typeof self && (e = self),
			(e.io = t());
	}
})(function() {
	var t;
					...
					function r(t, e) {
						...
						return (
							e.forceNew || e['force new connection'] || !1 === e.multiplex
								...
								: (c[p] || (a('new io instance for %s', i), (c[p] = s(i, e))), (n = c[p])),
							n.socket(r.path)
						);
					}
					var o = t('./url'),
				...
				function(t, e, n) {
					...
					i(r.prototype),
						...
						(r.prototype.close = r.prototype.disconnect = function() {
							return (
								this.connected &&
									(p('performing disconnect (%s)', this.nsp), this.packet({ type: o.DISCONNECT })),
								this.destroy(),
				...
				function(t, e) {
					...
					(e.exports = n),
						...
						(n.humanize = function(t) {
							...
							return t >= r
								? (t / r).toFixed(1) + 'h'
								: t >= n ? (t / n).toFixed(1) + 'm' : t >= e ? ((t / e) | 0) + 's' : t + 'ms';
						}),
				...
				function(t, e, n) {
					(function(e) {
						function r(t) {
							...
							if (((t.xdomain = r), (t.xscheme = a), (n = new o(t)), 'open' in n && !t.forceJSONP))
								return new i(t);
						...
						(e.exports = o),
								...
								try {
									...
									t =
										'application/octet-stream' === e
											? this.xhr.response
											: this.supportsBinary ? 'ok' : this.xhr.responseText;
								} catch (n) {
									this.onError(n);
								}
							...
							n.document &&
								...
								n.attachEvent
									...
									: n.addEventListener && n.addEventListener('beforeunload', s, !1));
					}.call(this, 'undefined' != typeof self ? self : 'undefined' != typeof window ? window : {}));
				},
					...
					s(n, r),
						...
						(n.prototype.doClose = function() {
							...
							'open' == this.readyState
								...
								: (a('transport not open - deferring close'), this.once('open', t));
						}),
						...
						(n.prototype.uri = function() {
							...
							return (
								!1 !== this.timestampRequests &&
									(t[this.timestampParam] = +new Date() + '-' + r.timestamps++),
			...
			24: [
				function(t, e) {
					...
					function i(t, e, n) {
						return e > t
							? void 0
							: 1.5 * e > t ? Math.floor(t / e) + ' ' + n : Math.ceil(t / e) + ' ' + n + 's';
					}
					var s = 1e3,
						a = 60 * s,
						c = 60 * a,
				...
				function(t, e, n) {
					(function(e) {
						...
						var c = t('./keys'),
							...
							g = d || y;
						n.protocol = 3;
						var m = (n.packets = { open: 0, close: 1, ping: 2, pong: 3, message: 4, upgrade: 5, noop: 6 }),
							v = c(m),
						...
						(n.encodePacket = function(t, n, i, a) {
							...
							(n.encodeBase64Packet = function(t, r) {
								...
								try {
									...
									for (
										var c = new Uint8Array(t.data), p = new Array(c.length), u = 0;
										u < c.length;
										u++
									)
										p[u] = c[u];
							...
							(n.decodePacket = function(t, e, r) {
								if ('string' == typeof t || void 0 === t) {
									...
									return Number(i) == i && v[i]
										? t.length > 1 ? { type: v[i], data: t.substring(1) } : { type: v[i] }
										: b;
								}
							...
							(n.encodePayload = function(t, e, r) {
								...
								var s = p(t);
								return e && s
									? w && !g ? n.encodePayloadAsBlob(t, r) : n.encodePayloadAsArrayBuffer(t, r)
									: t.length
							...
							(n.decodePayload = function(t, e, r) {
								...
								for (var i, s, a = '', c = 0, p = t.length; p > c; c++) {
									...
									if (':' != u) a += u;
										...
										if (s.length) {
											if (((o = n.decodePacket(s, e, !0)), b.type == o.type && b.data == o.data))
												return r(b, 0, 1);
											var f = r(o, c + i, p);
											if (!1 === f) return;
										}
			...
			28: [
				function(t, e) {
					e.exports = function(t, e, n) {
						...
						if ((0 > e && (e += r), 0 > n && (n += r), n > r && (n = r), e >= r || e >= n || 0 === r))
					...
					(function(e) {
						!(function(o) {
							...
							function c(t) {
								...
								return (
									0 == (4294965248 & t)
										? (e = b(((t >> 6) & 31) | 192))
										: 0 == (4294901760 & t)
											? ((e = b(((t >> 12) & 15) | 224)), (e += a(t, 6)))
											: 0 == (4292870144 & t) &&
												((e = b(((t >> 18) & 7) | 240)), (e += a(t, 12)), (e += a(t, 6))),
									(e += b((63 & t) | 128))
								);
							}
							function p(t) {
							...
							function f() {
								...
								if (224 == (240 & t)) {
									if (((e = u()), (n = u()), (o = ((15 & t) << 12) | (e << 6) | n), o >= 2048))
										return o;
									throw Error('Invalid continuation byte');
								}
								if (
							...
							var g,
								...
								w = { version: '2.0.0', encode: p, decode: h };
						...
						e.exports = function(e) {
							return 'string' == typeof e && e
								? ((e = e.replace(s, '').replace(a, '')),
									t.JSON && JSON.parse
										? JSON.parse(e)
										: n.test(e.replace(r, '@').replace(o, ']').replace(i, ''))
				...
				function(e, n, r) {
					!(function(e) {
						...
						if (!n('json')) {
							...
							(o = {}.hasOwnProperty) ||
								(o = function(t) {
									var e,
										n = {};
									return (
										((n.__proto__ = null), (n.__proto__ = { toString: 1 }), n).toString != a
											? (o = function(t) {
							...
							var A = { boolean: 1, number: 1, string: 1, undefined: 1 },
								B = function(t, e) {
									var n = typeof t[e];
								...
								var C = { 92: '\\\\', 34: '\\"', 8: '\\b', 12: '\\f', 10: '\\n', 13: '\\r', 9: '\\t' },
									...
									_ = function(t, e, n, r, c, p, u) {
										...
										if ('object' == typeof f && f)
											if (((h = a.call(f)), h != d || o.call(f, 'toJSON')))
												'function' == typeof f.toJSON &&
													((h != y && h != g && h != m) || o.call(f, 'toJSON')) &&
													(f = f.toJSON(t));
											else if (f > -1 / 0 && 1 / 0 > f) {
												if (x) {
													for (
														k = w(f / 864e5), l = w(k / 365.2425) + 1970 - 1;
														x(l + 1, 0) <= k;
														l++
													);
									...
									if ('function' == typeof e || ('object' == typeof e && e))
										if ((s = a.call(e)) == l) o = e;
											...
											for (
												...
												u > p;
												c = e[p++], s = a.call(c), (s == g || s == y) && (i[c] = 1)
											);
										}
									if (n)
										if ((s = a.call(n)) == y) {
								...
								var P,
										...
										for (var t, e, n, r, o, i = R, s = i.length; s > P; )
											switch ((o = i.charCodeAt(P))) {
												...
												default:
													if (
														((e = P),
														45 == o && ((r = !0), (o = i.charCodeAt(++P))),
														o >= 48 && 57 >= o)
													) {
														for (
															48 == o &&
																((o = i.charCodeAt(P + 1)), o >= 48 && 57 >= o) &&
																q(),
																r = !1;
															s > P && ((o = i.charCodeAt(P)), o >= 48 && 57 >= o);
															P++
														);
														if (46 == i.charCodeAt(P)) {
															for (
																n = ++P;
																s > n && ((o = i.charCodeAt(n)), o >= 48 && 57 >= o);
																n++
															);
															n == P && q(), (P = n);
														}
									...
									L = function(t, e, n) {
										...
										if ('object' == typeof o && o)
											if (a.call(o) == m) for (r = o.length; r--; ) I(o, r, n);
											else
												i(o, function(t) {
													I(o, t, n);
												});
